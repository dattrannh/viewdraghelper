...
//			if (xvel > 0 &&  mHeaderView.getBottom()==getHeight()) {
//				if (mDragHelper.smoothSlideViewTo(mHeaderView, getWidth(),
//						getHeight())) {
...
//				if (left >= dragRangeWidth) {
//					return dragRangeWidth;
//				} else if (left < 0) {
//					return 0;
//				}
//				return left;
...
//	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
        ...
        isHeaderViewUnder = mDragHelper.isViewUnder(mHeaderView, (int) x, (int) y);
...
//						smoothSlideTo(1f);
//					} else {
					if (mDragOffset !=0) smoothSlideTo(0f);
//					}
				}
				break;
			}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		dragRangeWidth = getWidth() - mHeaderView.getWidth();
